...
async def get_users(service: UserService = Depends(get_user_svc), limit: int = 10, offset: int = 1) -> UserListDto:
...
async def get_items(limit: int = 10, offset: int = 1):
    ...
    product = [
        ...
        "description": "ogurec"},
        {"id": 6,
        "description": "klubnika"},
        {"id": 7,
        "description": "grusha"},
        {"id": 8,
        "description": "vinograd"},
        {"id": 9,
        "description": "pomidor"},
        {"id": 10,
        "description": "baklajan"}
    ]
