...
async def main():
    ...
    access_token = token_svc.access_token(payload)  # 5 minuts
    refresh_token = token_svc.refresh_token(payload)  # 15 minuts
    ...
    print("Access token life ?", jwt_svc.verify_token(access_token))
